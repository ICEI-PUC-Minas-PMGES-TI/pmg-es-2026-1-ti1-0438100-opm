...
## Público-alvo
O projeto é feito para operadores de máquinas e gestores de produção . Como o ambiente industrial exige agilidade, a interface foi pensada para ser simples e direta, facilitando o uso mesmo por profissionais que não estão acostumados a sistemas complexos, mas que precisam de respostas rápidas na tela.
